...
const page = () => {
  ...
  return (
    <PageLayout style={false} title="Department Of Computer Science & Engineering" bg="https://snu.edu.in/site/assets/files/14210/html-system-website-concept_1.1600x0.webp">
      <div className=" p-8">
