    ...
    <footer className="pt-10 bg-slate-800">
      <div className="max-w-screen-xl mx-auto px-4 md:px-8">
        <div className="justify-between items-center gap-12 md:flex">
          <div className="flex-1 gap-y-5 max-w-lg">
            <img src="logo.png" width={110} alt="" className="mb-5" />
            <h3 className="text-2xl mt-3 font-bold">Sunamganj Science & Technology University</h3>
          </div>
          <div className="flex-1 mt-6 md:mt-0"></div>
        </div>
        <div className="flex-1 mt-16 space-y-6 justify-between sm:flex md:space-y-0">
          ...
          <div className="flex flex-col gap-y-3">
            ...
            <p className="text-gray-600">Sunamganj Science & Technology University</p>
            <div className="text-gray-600 flex gap-x-2 items-center">
              <div className="bg-green-500 flex text-lg rounded-full justify-center text-white items-center w-8 h-8">
                <CgPin className="inline-block" />
              </div>
              Sunamgnaj, Sylhet, Bangladesh
            </div>
            <div className="text-gray-600 flex gap-x-2 items-center">
              <div className="bg-green-500 flex text-lg rounded-full justify-center text-white items-center w-8 h-8">
            ...
            <div className="text-gray-600 flex gap-x-2 items-center">
              ...
              Email:
              <a href="mailto:sstu@sstu.ac.bd" className="text-green-500 hover:text-green-800 duration-150">
                sstu@sstu.ac.bd
              </a>
            </div>
          </div>
        ...
        <div className="mt-10 py-10 border-t items-center justify-between sm:flex">
          <p className="text-gray-600">© 2024 SSTU. All rights reserved.</p>
